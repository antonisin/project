...
(function (factory) {
    ...
    _.extend(Backbone.ModelBinder.prototype, {
        ...
        bind:function (model, rootEl, attributeBindings, options) {
            ...
            if (options != undefined && options.silent != undefined && options.silent == true) {
                return;
            } else {
        ...
        _bindModelToView: function () {
            this._model.on('change', function() { this._onModelChange(); }, this);
            ...
            for (elementBindingCount = 0; elementBindingCount < attributeBinding.elementBindings.length; elementBindingCount++) {
                ...
                for (boundElCount = 0; boundElCount < elementBinding.boundEls.length; boundElCount++) {
                    ...
                    if(!boundEl._isSetting){
                        ...
                        if (elementBinding.silentModelToView) return;
