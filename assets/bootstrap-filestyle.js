...
(function ($) {
    ...
    Filestyle.prototype = {
        ...
        htmlIcon: function () {
            if (this.options.icon) {
                return '<span class="fa fa-download '+this.options.iconName+'"></span> ';
            } else {
                return '';
            }
        },
        ...
        htmlInput: function () {
            if (this.options.input) {
                return '<input type="text" id="file" name="picture-file" class="form-control '+(this.options.size=='nr'?'':'input-'+this.options.size)+'" disabled> ';
            } else {
                return '';
            }
        },
